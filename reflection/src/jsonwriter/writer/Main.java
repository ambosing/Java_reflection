...
//        System.out.println(json);
        ...
        Actor actor1 = new Actor("Elijah Wood1", new String[]{"반지의 제왕", "좋은 아들"});
        Actor actor2 = new Actor("Elijah Wood2", new String[]{"반지의 제왕", "좋은 아들"});
        Actor actor3 = new Actor("Elijah Wood3", new String[]{"반지의 제왕", "좋은 아들"});
        Movie movie = new Movie("반지의 제왕", 8.8f, new String[]{"액션", "어드벤처", "드라마"}, new Actor[]{actor1, actor2, actor3});
//        String json = objectToJson(actor1, 0);
    ...
    private static String formatPrimitiveValue(Object instance, Class<?> type) {
        ...
        throw new RuntimeException(String.format("Type : %s는 지원하지 않습니다.", type.getName()));
    }
