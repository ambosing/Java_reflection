package annotation_retry;

import annotation_retry.annotations.InitializerClass;
import annotation_retry.annotations.InitializerMethod;
import annotation_retry.annotations.RetryOperation;
import annotation_retry.annotations.ScanPackages;
    ...
    private static List<Class<?>> getAllPackageClasses(Path packagePath, String packageName) throws IOException, ClassNotFoundException {
        ...
        for (Path filePath : files) {
            ...
            if (fileName.endsWith(".class")) {
                String classFullName = "annotation_retry." + packageName + "." + fileName.replaceFirst("\\.class$", "");
